                ...
                try {
                    ...
                    if ($infContent -match "Microsoft XPS Document Writer" -or $infContent -match "Microsoft Print to PDF") {
                        ...
                        try {
                            ...
                            Set-ItemProperty -Path $regPath -Name "BlockPrintDriver" -Value 1 -Type String

                            Set-ItemProperty -Path $regPath -Name "CompatScanStatus" -Value 0 -Type String

                            Set-ItemProperty -Path $regPath -Name "ReadinessStatus" -Value 0 -Type String

                            Set-ItemProperty -Path $regPath -Name "PreCacheStatus" -Value 0 -Type String
