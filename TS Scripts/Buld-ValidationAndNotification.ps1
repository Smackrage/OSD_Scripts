...
if ($fail) {
    ...
    $LogLink = "\\\\virginblue.internal\\applications$\\SCCMRepo$\\TaskSequenceLogs\\Failure\\$Name"
} else {
    ...
    $LogLink = "\\\\virginblue.internal\\applications$\\SCCMRepo$\\TaskSequenceLogs\\Success\\$Name"
}
